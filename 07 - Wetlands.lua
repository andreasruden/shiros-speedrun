...
You should be 25, but if not grind to [XP25-1950].
...
Complet the rest of the quest [QC289 The Cursed Crew].
...
-- Dun Modr
If not 26 yet, grind to [XP26].
Head nort to Dun Modr. Turn in [QT161 A Dark Threat Looms]. Skip follow-up.
Turn in [QT472 Fall of Dun Modr].
Accept [QA304 A Grim Task].
